...
class gui:
    def __init__(self, bot_amount=None):
        self.root = Tk()
        ...
        else: self.button_frame_function()
        self.root.mainloop()
        '''
    ...
    def start_gui(self):
        ...
        self.player_amount_button = Button(self.root, text="enter",
                                           command=lambda: self.check_num_players(int(self.player_amount_entry.get())),
    ...
    def button_frame_function(self, checking=None):
        ...
        self.moves = []
        if checking == None: self.checking_button = Button(self.button_frame, text="check", command=self.checking_button_command)
    ...
    def player_setup(self, num, cp=None):
        self.num = num
    ...
    def folding_button_command(self):
        ...
        self.quit = Button(self.cp_button_frame, text="quit", command=lambda: self.end_gui(root))
    ...
    def _bot_decisions(self):
        ...
        self.user_bid_label = Label(self.info_frame, text=f"You bet ${self.user_bet_amount}. You have ${self.g.user[1]} left.").pack()
