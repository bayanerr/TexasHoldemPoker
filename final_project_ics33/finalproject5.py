...
class gui:
    def __init__(self, root=None):
        ...
        self.player_amount_prompt = None
        self.player_amount = None
        self.player_amount_button = None

        self.g = None

        self.user_card_frame = None
        self.user_card_label = None
        self.card_1 = None
        self.card_2 = None
        self.card_1_image = None
        self.card_2_image = None
        ...
        self.checking_button = Button(button_frame, text="check", command=lambda: self.checking_button_command())
        self.folding_button = Button(button_frame, text="fold", command=lambda: self.folding_button_command())
        self.betting_button = Button(button_frame, text="bet", command=lambda: self.betting_button_command())
        ...
        self.bet_amount_button = Button(self.root, text="Enter", fg="black", bg="black", pady=10, padx=10, command=lambda: self._bot_decisions())

        self.user_bet_amount = 0
        self.user_bid_label = Label(self.root, bg='ghost white')
        self.bot_bids_label = Label(self.root, bg = "ghost white")
    ...
    def start_gui(self):
        ...
        self.player_amount_prompt = Label(self.root, text = "Insert the number of computer players you would like to play with and press enter (min=1, max=10) ", padx=85,pady=4, bg= "honeydew", fg="black")
        ...
        self.player_amount_button = Button(self.root, text="enter", command=lambda: self.check_num_players(int(self.player_amount_entry.get())), padx=10, pady=10, fg="black", bg="black")
    ...
    def check_num_players(self, num):
        if num >= 1 and num <= 10:
            self.player_setup(num)



    def player_setup(self, num):
    ...
    def betting_button_command(self):
        ...
        if int(self.g.user[2]) > 0:
            self.betting_label["text"] = "You currently have ${} max to bet!\nInsert the amount of money you would like to bet as a single integer, then press enter. ".format(self.g.user[2])
    ...
    def _bot_decisions(self):
        ...
        self.user_bid_label["text"] = f"You bet ${self.user_bet_amount}. You have ${self.g.user[1]} left."
